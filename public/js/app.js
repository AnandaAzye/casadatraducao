...
var menuMobile = function menuMobile() {
  var btnList = document.querySelector('.nav-header_button-mobile');
  var menuList = document.querySelector("[data='nav-header']");
  function openMenu(event) {
    if (event.type === 'touchstart') event.preventDefault();
    menuList.classList.toggle('active');
    var active = menuList.classList.contains('active');
...
/***/ "./resources/scss/pages/vagas/index.scss":
/*!***********************************************!*\
  !*** ./resources/scss/pages/vagas/index.scss ***!
  \***********************************************/
/*! no static exports found */
