                    ...
                    <td>
                        <table align="center" valign="center" width="500" border="0" style="margin:0 auto;">
                            <tbody>
                                ...
                                <tr>
                                    <td height="20">Tempo integral: <b>{{$data['tempo_integral']}}</b></td>
                                </tr>
                                <tr>
                                    <td height="20">Tempo Parcial: <b>{{$data['tempo_parcial']}}</b></td>
                                </tr>
                                <tr>
                                    <td height="20">Linkedln: <b>{{$data['link_linkedin']}}</b></td>
                                </tr>
                                <tr>
                                    <td height="20">Pais: <b>{{$data['pais']}}</b></td>
                                </tr>
                                <tr>
                                    <td height="20">Sobre: <br><b>{{$data['sobre']}}</b></td>
                                </tr>                     
                                <tr>
                                    <td>
                                        <p
